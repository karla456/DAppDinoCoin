...
//-------------------
  ...
  async consulta1(): Promise<void> {
    const consulta = this.consulta.get('consulta1')?.value;
    const resultado = await this.getBalanceByAccount(consulta);
...
//--------------------
  ...
  async exchangePoints(): Promise<void> {
    ...
    const ownerAddress = '0xFae4B19cC76984aBB0D1f3a4B083071b036CDBc1';
